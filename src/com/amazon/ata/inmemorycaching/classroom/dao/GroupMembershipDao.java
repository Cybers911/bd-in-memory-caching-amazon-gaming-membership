...
public class GroupMembershipDao {
    ...
    // This method will be called by the cache manager if the is a miss in the cache
    //it needs to receive a cahe-key deconstructed it and call the original DAO method
    public boolean isUserInGroup(GroupMembershipCacheKey theCacheKey) {
          return this.isUserInGroup(theCacheKey.getGroupId(), theCacheKey.getUserId());
    }
